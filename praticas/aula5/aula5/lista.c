...
void TLista_Inicia(TLista *pLista) {
    ...
    //aloca memoria para a celula
    pLista->prim = (TCelula*) calloc(1,sizeof(TCelula));
    
    //o apontador prox da primeira celula aponta NULL
    pLista->prim->prox = NULL;

    //o apontador ult aponta para a cabeça
...
int TLista_InsereFinal(TLista *pLista, TItem x) {
    ...
    //o apontador ultimo aponta para a ultima celula que acabou de ser cria
